...
import com.example.androidlesson22.source.remote.api.repositories.CategoryRepository
...
import com.example.androidlesson22.source.local.room.maping.toProduct
import com.example.androidlesson22.source.local.room.maping.toProductEntity
import com.example.androidlesson22.source.local.room.repositories.EntityRepository
...
@HiltViewModel
class HomeViewModel @Inject constructor(private val repo: CategoryRepository, private val repo2: ProductRepository, private val repo3: EntityRepository) : ViewModel() {
